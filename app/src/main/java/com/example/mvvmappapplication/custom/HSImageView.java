...
public class HSImageView extends AppCompatImageView implements ThemeUtil.ITheme {
    ...
    public HSImageView(Context context, AttributeSet attrs) {
        super(context, attrs);
        initAttrs(attrs);
    }

    public HSImageView(Context context, AttributeSet attrs, int defStyleAttr) {
