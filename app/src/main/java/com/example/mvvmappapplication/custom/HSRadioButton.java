...
public class HSRadioButton extends AppCompatRadioButton implements ThemeUtil.ITheme {
    ...
    public HSRadioButton(Context context, AttributeSet attrs) {
        super(context, attrs);
        initAttrs(attrs);
    }

    public HSRadioButton(Context context, AttributeSet attrs, int defStyleAttr) {
