...
public class HSUntactCardView extends MaterialCardView implements ThemeUtil.ITheme {
    ...
    public HSUntactCardView(Context context, AttributeSet attrs) {
        super(context, attrs);
        initAttrs(attrs);
    }

    public HSUntactCardView(Context context, AttributeSet attrs, int defStyleAttr) {
