...
public class HSUntactView extends View implements ThemeUtil.ITheme {
    ...
    public HSUntactView(Context context, AttributeSet attrs) {
        super(context, attrs);
        initAttrs(attrs);
    }

    public HSUntactView(Context context, AttributeSet attrs, int defStyleAttr) {
