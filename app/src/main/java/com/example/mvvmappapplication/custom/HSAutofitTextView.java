...
/**
 * Created by jaehyun on 2017. 2. 14..
 */

public class HSAutofitTextView extends HSTextView implements AutofitHelper.OnTextSizeChangeListener {

    private AutofitHelper mHelper;

    public HSAutofitTextView(Context context) {
        super(context);
        init(null, 0);
    }

    public HSAutofitTextView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
    }

    public HSAutofitTextView(Context context, AttributeSet attrs, int defStyle) {
