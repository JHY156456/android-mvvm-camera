...
public class SlideshowViewModel extends AndroidViewModel {
    ...
    public void setRepositoryListView(RepositoryListViewContract repositoryListViewContract){
        this.repositoryListView = repositoryListViewContract;
    }
    ...
    private void loadRepositories(String langugae) {
        ...
        observable.subscribeOn(Schedulers.io()).observeOn(AndroidSchedulers.mainThread())
                .subscribe(new Observer<GitHubService.Repositories>() {
                    ...
                    @Override
                    public void onNext(GitHubService.@io.reactivex.rxjava3.annotations.NonNull Repositories repositories) {
